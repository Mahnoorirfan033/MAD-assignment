...
//concat: 
console.log(name.concat(" is a student"));
//trim:
console.log(name.trim());
//includess: 
console.log(name.includes("noor"));
//startsWith:
console.log(name.startsWith("noor"));
//endsWith:
console.log(name.endsWith("noor"));
//charsCodeAt:
console.log(name.endsWith("noor"));
//charsCodeAt: 
console.log(name.charCodeAt(3));
...
//match:
console.log(name.match("Mahnoor irfan"));
//matchAll:
console.log(name.matchAll("noor"));
//typeof: 
console.log(name.typeof);


// Array Methods
let numbers = [10, 30, 40, 90, 50];
...
console.log("Sliced Array (1-4):", numbers.slice(1, 3));
